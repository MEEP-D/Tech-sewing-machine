...
class NewsletterSubscriberResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Người nhận email';
    protected static ?string $modelLabel = 'Người nhận email';
    protected static ?string $pluralModelLabel = 'Người nhận email';
