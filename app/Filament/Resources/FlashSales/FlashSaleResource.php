...
class FlashSaleResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Khuyến mãi nhanh';

    protected static ?string $modelLabel = 'Khuyến mãi nhanh';

    protected static ?string $pluralModelLabel = 'Khuyến mãi nhanh';
