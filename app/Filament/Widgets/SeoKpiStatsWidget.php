...
class SeoKpiStatsWidget extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $focusKeywordCount = SeoMeta::query()->whereNotNull('focus_keyword')->where('focus_keyword', '!=', '')->count();

        return [
            Stat::make('Tổng lượt xem', number_format($totalViews))
                ->description('Sản phẩm + bài viết')
