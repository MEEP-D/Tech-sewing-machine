...
<p style="margin:0 0 14px;color:#374151;line-height:1.7;">{{ $post->excerpt ?: 'Bài viết mới đã được cập nhật trên website TechSewing.' }}</p>
<p style="margin:0 0 22px;color:#4b5563;line-height:1.75;">Nhấn vào nút dưới đây để xem chi tiết nội dung mới nhất.</p>
<p style="margin:0 0 30px;"><a href="{{ $post->url }}" style="display:inline-block;padding:12px 24px;border-radius:10px;background:#0ea5e9;color:#fff;text-decoration:none;font-weight:700;">Đọc bài viết</a></p>
<hr style="border:none;border-top:1px solid #e5e7eb;margin:0 0 20px 0;">
<p style="margin:0;font-size:12px;color:#6b7280;line-height:1.6;">Bạn đang nhận email này vì đã đăng ký từ website TechSewing.<br>Nếu không muốn nhận nữa? <a href="{{ $unsubscribeUrl }}" style="color:#0ea5e9;">Hủy đăng ký</a></p>
</td></tr>
</table>
</td></tr>
</table>
